...
class LoginMessage : public Message {
  public:
    ...
    // typedef std::_Bind<void (LoginWindow::*(LoginWindow*, std::_Placeholder<1>,
    // std::_Placeholder<2>))(bool, std::__cxx11::basic_string<char>)>
    // LoginCallBack ;
...
class TextMessage : public Message {
  ...
  public:
    const EString &getUsername() { return username; }
    void setUserName(const EString &name) { username = name; }
    const EString &getContent() { return content; }
    void setContent(const EString &cnt) { content = cnt; }
...
class QueryUserInformationMessage : public Message {
  public:
    // typedef void (*QueryUserInformationCallBack) (vector<struct userinfo>
    // &user_list); typedef _Bind<void (AddFriend::*(AddFriend*,
    // std::_Placeholder<1>))(std::vector<Netmodule::userinfo>&)>
    // QueryUserInformationCallBack;
...
class RequestFriendMessage : public Message {
  public:
    // typedef void (*RequestFriendCallBack) (bool success, bool permission,
    // string cause); static RequestFriendCallBack resultCallBack;
  private:
    static unsigned int type_num;
    EString username;
    EString note;
...
class QueryFriendListMessage : public Message {
  public:
    // typedef void (*QueryFriendListMessageCallBack) (vector<struct userinfo>
    // &friends_list); typedef _Bind<void (MainWindow::*(MainWindow*,
    // std::_Placeholder<1>))(std::vector<userinfo>&)>
    // QueryFriendListMessageCallBack;
