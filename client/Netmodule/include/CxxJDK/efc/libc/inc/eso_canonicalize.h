 ...
 * Apache-License-2.0
 * Change in this file:
 * comment function int canonicalize(const char *path, char *out, int len);
 * because this function seems not used and conflict with another function in stand math lib
 */
