...
INSERT INTO `friend` VALUES ('foo','bar'),('bar','foo');
...
CREATE TABLE `message` (
  `date` char(19) DEFAULT NULL,
  `sentUser` char(20) DEFAULT NULL,
  `receiveUser` char(20) DEFAULT NULL,
...
INSERT INTO `message` VALUES ('2019-01-02-08-57-29','foo','bar','hello, bar :)');
...
-- Dump completed on 2019-04-01 11:44:42
